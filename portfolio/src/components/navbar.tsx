...
const Navbar = () => {
  ...
  const hoverEff =
    "mx-2 px-1 font-[600] hover:text-sky-600 dark:hover:text-sky-500";
            ...
            <div className={`menu md:flex items-center hidden mt-5`}>
              ...
              >
                <h1
                  ...
                  className={`${
                    selected === "home" ? "text-sky-600 dark:text-sky-500" : ""
                  } ${hoverEff}`}
                >
                  Home
                </h1>
              ...
              >
                <h1
                  ...
                  className={`${
                    selected === "about" ? "text-sky-600 dark:text-sky-500" : ""
                  } ${hoverEff}`}
                >
                  About
                </h1>
                  ...
                  <div className="flex flex-col my-3 items-center ">
                    ...
                    >
                      <div className="flex w-full justify-center">
                        <h1 className="flex mt-8 mb-2 ">Home</h1>
                      </div>
                    </Link>
                    <Link
                      to="about"
                    ...
                    >
                      <div className="flex w-full justify-center">
                        <h1 className="flex mt-8 mb-2">About</h1>
                      </div>
                    </Link>
                    <Link
                      to="skills"
                    ...
                    >
                      <div className="flex w-full justify-center">
                        <h1 className="flex mt-8 mb-2">Skills</h1>
                      </div>
                    </Link>
                    <Link
                      to="projects"
                    ...
                    >
                      <div className="flex w-full justify-center">
                        <h1 className="flex mt-8 mb-2">Projects</h1>
                      </div>
                    </Link>
                    ...
                    >
                      <div className="flex w-full justify-center">
                        <h1 className="flex mt-8 mb-2">Connect</h1>
                      </div>
                    </Link>
                  </div>
                </SheetContent>
